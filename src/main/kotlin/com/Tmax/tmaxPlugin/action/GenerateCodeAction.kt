...
import com.Tmax.tmaxPlugin.dialog.GenerateCodeDialog
import com.Tmax.tmaxPlugin.settings.SettingsState
...
class GenerateCodeAction : AnAction() {
    ...
    override fun actionPerformed(event: AnActionEvent) {
        ...
        val dialog = GenerateCodeDialog(editor, project, selectedCode)
